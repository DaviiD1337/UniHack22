    ...
    public class MockDataStore : IDataStore<Item>
    {
        ...
        public MockDataStore()
        {
            items = new List<Item>()
            {
                ...
                new Item { Id = Guid.NewGuid().ToString(), Text = "Fourth item", Description="This is an item description.",Location = "Timisoara",Rating = 0},
                new Item { Id = Guid.NewGuid().ToString(), Text = "Fifth item", Description="This is an item description.",Location = "Timisoara",Rating = 0 },
                new Item { Id = Guid.NewGuid().ToString(), Text = "Sixth item", Description="This is an item description.", Location = "SatuMare",Rating = 0}
            };
        }
